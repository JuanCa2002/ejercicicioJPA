...
class BorrowRepositoryTest {
    ...
    fun createTest(){
        ...
        val book= Book("123","Harry Poter","444",publisher)
    ...
    fun findByUserTest(){
        ...
        val publisher=Publisher("Norma",14)
        entityManager.persist(publisher)
        val bookOne= Book("123","Harry Potter","444",publisher)
        entityManager.persist(bookOne)
        val bookTwo= Book("421","Alicia en el pais de la marav","555",publisher)
    ...
    fun findByBookTest(){
        ...
        val bookOne= Book("123","Harry Potter","444",publisher)
        entityManager.persist(bookOne)
        val bookTwo= Book("421","Alicia en el pais de la maravillas","555",publisher)
        entityManager.persist(bookTwo)
        val bookThree= Book("821","Los juegos del hambre","666",publisher)
