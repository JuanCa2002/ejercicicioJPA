...
class AuthorBookRepositoryTest {
    ...
    fun findByAuthorTest(){
        val publisher= Publisher("Norma",14)
        entityManager.persist(publisher)
        val bookOne= Book("123","Harry Poter","444",publisher)
        entityManager.persist(bookOne)
        val bookTwo= Book("421","Alicia en el pais de las maravillas","555",publisher)
        entityManager.persist(bookTwo)
        val bookThree= Book("521","Los juegos del hambre","666",publisher)
